...
export default function LoginPage() {
  return (
    <div className="bg-background-dark text-slate-100 min-h-screen flex items-center justify-center p-4 overflow-x-hidden">
      ...
      <div className="fixed top-[-10%] left-[-5%] w-[40%] h-[40%] bg-secondary/10 blur-[120px] -z-10" />
      <div className="fixed bottom-[-10%] right-[-5%] w-[40%] h-[40%] bg-primary/5 blur-[120px] -z-10" />
      ...
      <div className="fixed top-10 right-10 w-12 h-12 neubrutal-border bg-secondary shadow-neubrutal rotate-12 -z-10 hidden md:block" />
      <div className="fixed bottom-20 left-10 w-16 h-8 neubrutal-border bg-primary shadow-neubrutal -rotate-6 -z-10 hidden md:block" />
    </div>
  );
}
